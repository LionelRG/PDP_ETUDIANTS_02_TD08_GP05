...
#define TEMPERATURE "TD08_GP05/temp"
#define HUMIDITE "TD08_GP05/relhum"


const char* wifi_ssid = "Ines";
const char* wifi_password = "ines2001";
...
const char* client_id = "TD08_GP05";
...
void setup() {
  ...
  {
    mqtt_client.publish("TD08_GP05/temp", String(temp_measure).c_str());
    mqtt_client.publish("TD08_GP05/relhum", String(relative_humidity_measure).c_str());
  }
  // ...
